...
5. Convert the Qualification Plan back to json format
6. Run the updated Qualification Plan


## Fetch latest release

Steps 1 and 2 usually involve using the latest release version of project snapshots, observed data and qualification plans. This can be done using the function `getLatestReleasedPaths()` as illustrated below:
...
- [Add a Snapshot to my Qualification Plan](./snapshot-qualification.html)
