...
This article shows how to add and integrate a project Snapshot (json)
into a Qualification Plan. The example used here is the qualification
plan for UGT1A1- and UGT1A9-mediated inhibition drug-drug interactions
(DDI) available in the
[Qualification-DDI-UGT](https://github.com/Open-Systems-Pharmacology/Qualification-DDI-UGT)
GitHub repository and the project snapshot
...
#> ✔ Copying Excel Template to qualification_ugt.xlsx [201ms]
#> 
...
#> ✔ Exporting Simulation Outputs Data [2s]
#> 
#> ℹ Exporting Simulation Observed Data
#> ✔ Exporting Simulation Observed Data [812ms]
#> 
